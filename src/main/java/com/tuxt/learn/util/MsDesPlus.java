...
public class MsDesPlus {
	 ...
	 *             本方法不处理任何异常，所有异常全部抛出
	 */
	private String byteArrToHexStr(byte[] arrB) throws BusiException {
	 ...
	 *             本方法不处理任何异常，所有异常全部抛出
	 */
	private byte[] hexStrToByteArr(String strIn) throws BusiException {
	 ...
	 * @throws BusiException
	 */
	public MsDesPlus() throws BusiException {
		this(strDefaultKey);
	}
	 ...
	 * @throws BusiException
	 */
	public MsDesPlus(String strKey) throws BusiException {
		try {
			...
			throw new BusiException(BusiException.SYS_ERR, e.getMessage(), e);
		}
	}
	 ...
	 * @throws BusiException
	 */
	private byte[] encrypt(byte[] arrB) throws BusiException {
		try {
	 ...
	 * @throws BusiException
	 */
	public String encrypt(String strIn) throws BusiException {
	 ...
	 * @throws BusiException
	 */
	private byte[] decrypt(byte[] arrB) throws BusiException {
		try {
	 ...
	 * @throws BusiException
	 */
	public String decrypt(String strIn) throws BusiException {
		try {
	 ...
	 * @throws BusiException
	 */
	public String decrypt(String strIn, String encode) throws BusiException {
		try {
	 ...
	 */
	private Key getKey(byte[] arrBTmp) throws BusiException {
		// 创建一个空的8位字节数组（默认值为0）
